  ...
  let message = [
    ...
    },
    {
      ...
      text: ['可以休息了嗎？',
        ...
        '我就這樣放空大腦，結束了一天的活動。',
        '總之，我決定當天就此休息，便躺到了床上。',
        '沒想到，我就這樣邊思考著蒼月的事，邊在不知不覺中墜入了夢鄉。',
        '睡覺也是一種準備……必須保證睡眠充足。']
    },
    {
      chack: ['早安'],
      text: ['早啊，{userName}。昨晚有睡好嗎？',
        '呼啊……早。',
        '大家，早安啊！有沒有充滿幹勁啊——！？',
        '早安，{userName}。今天也能安穩度過就太好了。',
        '早安，{userName}。吃過早餐了嗎？']
    },
    {
      chack: ['午安'],
      text: ['是{userName}啊，午安。今天過得還好嗎？',
        '午安，{userName}。肚子有點餓了，不知道要吃什麼……',
        '午安，{userName}。下午有打算做什麼嗎？',
        '午安，{userName}。我今天也會一直待在這裡，所以需要幫忙就隨時找我吧。']
    },
    {
      chack: ['晚安'],
      text: ['晚安，我也要去睡了。',
    ...
    },
    {
      ...
      text: ['特防部隊！世界第一！永生不滅！所向無敵！風霜雨雪！絕不氣餒！特防部隊！曠世無匹！',
        ...
        '是魚兒！好可愛呀！',
        '哇！是噴泉！嗶嗶嗶！我在幹什麼呢……',
        '是我太天真了……我不該讓他死得那麼痛快。\n為了讓他再也不敢與我們作對……甚至後悔誕生在這世上……\n我本該讓他死無葬身之地的。',
        '就像那懸掛在澄澈原野上空的蒼藍之月……一樣。',
        '他連我的外貌都認不清，又怎麼能認清我靈魂的型態呢。']
    },
{
  chack: ['我生日', '我的生日'],
  text: [
